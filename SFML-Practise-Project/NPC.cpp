...
NPC::NPC(sf::Texture* texture, sf::Font& interact_font, sf::Font& npc_message_font, sf::SoundBuffer& sound_buffer, sf::Texture& speechTexture, sf::Vector2f size, sf::Vector2u imageCount, sf::Vector2f pos, float switchTime)
